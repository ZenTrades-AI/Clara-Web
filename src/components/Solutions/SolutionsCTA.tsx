        ...
        <section className="relative py-32 px-4 overflow-hidden bg-gradient-to-br from-[#0a0a0a] via-[#1a0a0e] to-[#0a0a0a]">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
                    ...
                    <Button size="lg" variant="outline" className="text-lg px-10 py-7 border-2 border-white/20 text-black hover:bg-white hover:text-black rounded-full font-semibold transition-all duration-300" onClick={openHubSpotForm}>
                        See How Clara Works
                    </Button>
                </div>
            </div>
