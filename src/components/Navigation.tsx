...
const caseStudyLinks = [
  { name: "Case Studies Overview", href: "/case-studies", desc: "See how contractors succeed with Clara" },
  { name: "HVAC Case Studies", href: "/case-studies?industry=HVAC", desc: "Heating and cooling success stories" },
  { name: "Plumbing Case Studies", href: "/case-studies?industry=Plumbing", desc: "Plumbing contractor transformations" },
  { name: "Electrical Case Studies", href: "/case-studies?industry=Electrical", desc: "Electrical business growth" },
  { name: "Fire Protection Case Studies", href: "/case-studies?industry=Fire%20Protection", desc: "Fire safety contractor wins" },
];
