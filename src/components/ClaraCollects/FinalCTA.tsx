    ...
    <section className="relative py-32 px-4 overflow-hidden bg-[#121212]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        <h2 className="text-5xl md:text-6xl font-bold text-white leading-tight">
          ...
          <br />
          <span className="text-primary">Start collecting faster.</span>
        </h2>

        <p className="text-xl text-[#FAFAFA]/80 max-w-2xl mx-auto leading-relaxed">
          Let Clara automate your collections and improve your cash flow.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          ...
          <Button size="lg" className="text-lg px-10 py-7 bg-white text-[#121212] hover:bg-[#FAFAFA] transition-all duration-300 shadow-premium font-semibold border-2 border-white" onClick={openClaraLiveForm}>
