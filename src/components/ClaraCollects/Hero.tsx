    ...
    <section className="relative py-24 md:py-32 px-6 overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
          Clara Collects: Get Paid Faster <span className="text-primary">Without Chasing Customers</span>
        </h1>

        <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed">
          Clara turns unpaid invoices into collected revenue through AI-driven multi-channel reminders. Reduce AR days and boost cash flow.
        </p>
        ...
        <p className="text-sm text-muted-foreground">
          Get paid 30–40% faster without adding collection staff
        </p>
      </div>
    </section>
  );
