...
const steps = [
  {
    ...
    icon: Search,
    title: "Discover",
    description: "We analyze your invoicing patterns and identify collection opportunities.",
  },
  {
    number: 2,
    icon: Settings,
    title: "Configure",
    description: "Clara learns your payment terms, reminder cadence, and escalation rules.",
  },
  {
    number: 3,
    icon: Link2,
    title: "Integrate",
    description: "Seamless connection to your invoicing system and payment processors.",
  },
  {
    number: 4,
    icon: Rocket,
    title: "Launch & Optimize",
    description: "Go live in under 3 days and start collecting faster automatically.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Launch Clara Collects in under 3 days with zero hassle
          </p>
        </div>
