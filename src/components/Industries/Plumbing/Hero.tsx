            ...
            <div className="container relative mx-auto px-4 z-10">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 tracking-tight">
                        The AI Growth Engine Built for <span className="text-clara-red">Plumbing Companies</span>
                    </h1>

                    <p className="text-xl text-gray-600 max-w-2xl mb-10 leading-relaxed">
                        How Clara helps plumbing businesses capture every emergency call, document service work accurately, and collect on completed jobs.
                    </p>
