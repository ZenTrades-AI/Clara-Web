const PlumbingDataFlow = () => {
    const steps = [
        {
            number: "1",
            title: "Customer Calls",
            description: "Emergency or service request comes in any time"
        },
        {
            number: "2",
            title: "Intent Captured",
            description: "Clara understands urgency and problem type"
        },
        {
            number: "3",
            title: "Service Executed",
            description: "Field Co-Pilot documents diagnostics and repairs"
        },
        {
            number: "4",
            title: "Records Synced",
            description: "Work orders and photos flow to your systems"
        },
        {
            number: "5",
            ...
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h2 className="text-4xl font-bold text-gray-900 mb-6">
                        How Data Flows Through Clara for Plumbing
                    </h2>
...
export default PlumbingDataFlow;
