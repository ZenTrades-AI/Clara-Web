const ElectricalDataFlow = () => {
    const steps = [
        {
            number: "1",
            title: "Customer Calls",
            description: "Service request or project inquiry comes in"
        },
        {
            number: "2",
            title: "Intent Captured",
            description: "Clara understands scope and schedules appropriately"
        },
        {
            number: "3",
            title: "Work Documented",
            description: "Field Co-Pilot captures installation details and testing"
        },
        {
            number: "4",
            title: "Records Synced",
            description: "Job documentation flows to your systems"
        },
        {
            number: "5",
            ...
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h2 className="text-4xl font-bold text-gray-900 mb-6">
                        How Data Flows Through Clara for Electrical
                    </h2>
                    <p className="text-xl text-gray-600">
                        From the first service call to final payment collection, Clara keeps everything connected.
                    </p>
                </div>
...
export default ElectricalDataFlow;
