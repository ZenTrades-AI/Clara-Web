...
const PlumbingStaffShortage = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            <Helmet>
                <title>Solve Plumbing Staff Shortages | Clara AI</title>
                <meta name="description" content="Do more service calls with fewer plumbers. Clara's AI Field Co-Pilot helps you train new hires faster and scale your plumbing business." />
            </Helmet>
                    ...
                    <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        <div className="max-w-6xl">
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 text-foreground leading-[1.1] tracking-tight">
                                Do more service calls with fewer <br />
                                plumbers
                            </h1>

                            <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed">
                                Good plumbers are impossible to find. Clara helps you train new hires faster, reduce
                                callbacks, and get more revenue out of the team you already have.
                            </p>
            ...
            <RevealOnScroll>
                <section className="py-20 px-6 bg-white">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-12">Plumbers are retiring faster than you can hire</h2>
                        <div className="text-lg md:text-xl text-muted-foreground space-y-8 leading-relaxed text-left">
                            <p>
                                <span className="font-bold text-foreground">Plumbing businesses are facing a crisis.</span> The master plumbers are retiring, and the new generation doesn't have the experience to handle complex jobs alone.
                            </p>
                            <p>
                                Companies are forced to send two guys to do a one-man job, or worse, send a green tech who messes it up. Callbacks kill your margins and your reputation.
                            </p>
                            <p>
                                <span className="font-bold text-foreground">You can't clone your master plumber. But you can give his brain to everyone on your team.</span>
                            </p>
                            <p>
                                That's why <span className="font-bold text-[#D32F2F]">Clara Field Co-Pilot</span> acts as a virtual journeyman, guiding your apprentices through every step of the job to ensure it's done right the first time.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-20 px-6 bg-white">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-4xl font-bold mb-4">Confidence on Every Call</h2>
                            <p className="text-muted-foreground max-w-2xl mx-auto">
                                Turn your apprentices into profitable technicians in weeks, not years.
                            </p>
                        </div>
                            ...
                            {[
                                {
                                    step: "1",
                                    icon: Users,
                                    title: "Tech arrives on-site",
                                    description: "The tech puts on the glasses. Clara recognizes the water heater model and pulls up the installation checklist."
                                },
                                {
                                    step: "2",
                                    icon: Shield,
                                    title: "Clara guides and documents",
                                    description: "Clara walks them through the diagnosis or install step-by-step. 'Check the expansion tank pressure.' 'Verify the gas line sizing.' It catches mistakes before they happen."
                                },
                                {
                                    step: "3",
                                    icon: TrendingUp,
                                    title: "Clean data flows to your systems",
                                    description: "Photos of every critical step are automatically saved to the job file. The invoice is generated with the correct parts and labor codes."
                                }
                            ].map((item, i) => (
                ...
                <section className="py-20 px-6">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-muted-foreground">A scalable workforce that delivers consistent quality.</p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    description: "Complete jobs 30% faster with AI guidance."
                                },
                                {
                                    title: "Zero callbacks",
                                    description: "Catch errors while the tech is still on site."
                                },
                                {
                                    title: "Better documentation",
                                    description: "Protect your license with photo proof."
                                },
                                {
                                    title: "Faster training",
                                    description: "Onboard new hires in half the time."
                                },
                                {
                                    title: "100% consistency",
                                    description: "Every tech follows the same process."
                                },
                                {
                                    title: "Premium service",
                                    description: "Show customers you use the best tech."
                                }
                            ].map((item, i) => (
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-8 text-center border border-gray-100">
                                <p className="text-lg text-muted-foreground italic max-w-3xl mx-auto">
                                    "You send a new hire to replace a water heater. It's a simple job, but if he forgets the expansion tank or the pan, you're liable."
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="p-8 bg-red-50/50 rounded-2xl border border-red-100">
                                    ...
                                    <p className="text-sm text-gray-600 leading-relaxed">
                                        Before Clara: He forgets to check the pressure on the expansion tank. Two weeks later, the T&P valve blows, floods the basement, and you're paying for restoration.
                                    </p>
                                </div>
                                ...
                                <div className="p-8 bg-green-50/50 rounded-2xl border border-green-100">
                                    ...
                                    <p className="text-sm text-gray-600 leading-relaxed">
                                        With Clara: Clara prompts him: "Check expansion tank pressure." He reads it out loud. Clara says, "Pressure is too high, adjust to match static pressure." He fixes it, takes a photo, and the job is done right.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="p-8 bg-red-50 rounded-2xl border border-red-100">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    You sleep better at night knowing every job is up to code. Your new hire gains confidence and becomes profitable faster.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-20 px-6 bg-gray-50">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-4 mb-12">
                            {[
                                "Plumbing codes are strict and vary by location; Clara knows them all",
                                "Liability for water damage is huge; documentation is your defense",
                                "Technical knowledge is hard to transfer; Clara makes it accessible"
                            ].map((item, i) => (
                        ...
                        <p className="text-center text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                            Clara is the force multiplier your plumbing business has been waiting for.
                        </p>
                    </div>
                </section>
            </RevealOnScroll>
                ...
                <section className="py-24 px-6 bg-white">
                    <div className="max-w-4xl mx-auto text-center">
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
                            See how Clara can solve staff shortage for your plumbing business
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-[#0A1A2F] p-8 rounded-3xl text-white relative overflow-hidden group">
                                <div className="relative z-10">
                                    ...
                                    <p className="text-gray-400 text-sm mb-8">Identify opportunities for upgrades and maintenance plans automatically.</p>
            ...
            <div className="bg-black text-white py-24 px-6 text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-8">Ready to see Clara Field Co-Pilot in action for plumbing teams?</h2>
...
export default PlumbingStaffShortage;
