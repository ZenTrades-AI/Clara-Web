...
const RoofingCollectsGrowth = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            <Helmet>
                <title>Fuel Roofing Growth | Clara AI</title>
                <meta name="description" content="Fuel roofing growth with faster payments. Clara's AI automates collections so you can invest in materials and new jobs." />
            </Helmet>
                    ...
                    <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        <div className="max-w-6xl">
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 text-foreground leading-[1.1] tracking-tight">
                                Fuel roofing growth with <br />
                                faster payments
                            </h1>

                            <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed">
                                Roofing is cash intensive. Clara automates your collections so you have the working capital
                                to buy materials, pay crews, and take on more jobs.
                            </p>
            ...
            <RevealOnScroll>
                <section className="py-20 px-6 bg-white">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-12">Cash flow kills roofing companies</h2>
                        <div className="text-lg md:text-xl text-muted-foreground space-y-8 leading-relaxed text-left">
                            <p>
                                <span className="font-bold text-foreground">Materials are expensive.</span> You have to front thousands of dollars for shingles and supplies before you even start a job.
                            </p>
                            <p>
                                <span className="font-bold text-foreground">Insurance checks are slow.</span> Waiting on adjusters and mortgage companies to release funds can take weeks or months.
                            </p>
                            <p>
                                <span className="font-bold text-foreground">Growth requires capital.</span> If you want to add another crew or expand to a new territory, you need cash in the bank, not in accounts receivable.
                            </p>
                            <p>
                                That's why <span className="font-bold text-[#7C3AED]">Clara Collects</span> is essential. She accelerates your payments so you can reinvest in your business and keep growing.
                            </p>
                        </div>
                    </div>
                </section>
                            ...
                            {[
                                {
                                    ...
                                    description: "As soon as the roof is done, the invoice goes out. Clara integrates with your CRM."
                                },
                                {
                                    step: "2",
                                    icon: Clock,
                                    title: "Clara sends persistent reminders",
                                    description: "She follows up with homeowners and insurance companies consistently. She doesn't get tired or distracted."
                                },
                                {
                                    step: "3",
                                    icon: DollarSign,
                                    title: "Payment arrives faster",
                                    description: "You get paid weeks earlier. That means you can buy materials for the next job without stress."
                                }
                            ].map((item, i) => (
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                {
                                    title: "Less debt",
                                    description: "Reduce reliance on supplier credit lines."
                                },
                                {
                                    title: "Scalability",
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-8 text-center border border-gray-100">
                                <p className="text-lg text-muted-foreground italic max-w-3xl mx-auto">
                                    "A storm just hit. You have 50 leads coming in, but you're maxed out on your credit line because you're waiting on checks from last month's jobs."
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="p-8 bg-red-50/50 rounded-2xl border border-red-100">
                                    ...
                                    <p className="text-sm text-gray-600 leading-relaxed">
                                        Before Clara: You have to turn down work or scramble for a high-interest loan. You lose market share to competitors who have cash.
                                    </p>
                                </div>
                                ...
                                <div className="p-8 bg-purple-50/50 rounded-2xl border border-purple-100">
                                    ...
                                    <p className="text-sm text-gray-600 leading-relaxed">
                                        With Clara: Your receivables are current. You have cash in the bank. You buy the materials, hire the extra crew, and dominate the storm response.
                                    </p>
                                </div>
                            </div>
                ...
                <section className="py-20 px-6 bg-gray-50">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-4 mb-12">
                            {[
                                "High material costs mean cash flow is critical",
                                "Insurance delays require persistent follow-up",
                                "Scalability depends on working capital availability"
                            ].map((item, i) => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-[#10B981] p-8 rounded-3xl text-white relative overflow-hidden group">
                                <div className="relative z-10">
                                    ...
                                    <p className="text-green-100 text-sm mb-8">Ensure your junior roofers are doing the job right.</p>
                            ...
                            <div className="bg-[#0A1A2F] p-8 rounded-3xl text-white relative overflow-hidden group">
                                <div className="relative z-10">
                                    ...
                                    <p className="text-gray-400 text-sm mb-8">AI receptionist that handles calls 24/7.</p>
            ...
            <div className="bg-black text-white py-24 px-6 text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-8">Ready to see Clara Collects in action for roofing teams?</h2>
...
export default RoofingCollectsGrowth;
