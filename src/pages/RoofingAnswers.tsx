...
const RoofingAnswers = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            <Helmet>
                <title>Roofing Answering Service & Call Center AI | Clara AI</title>
                <meta name="description" content="Answer every roofing call without hiring. Clara's AI receptionist handles storm surges, qualifies leads, and books appointments 24/7." />
            </Helmet>
                    ...
                    <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        <div className="max-w-6xl">
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 text-foreground leading-[1.1] tracking-tight">
                                Answer every roofing call without <br />
                                hiring
                            </h1>

                            <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed">
                                Storms don't wait for office hours. Clara scales instantly to handle thousands of calls,
                                qualifying leads and booking inspections while your competition goes to voicemail.
                            </p>
            ...
            <RevealOnScroll>
                <section className="py-20 px-6 bg-white">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-12">Staffing for storms is impossible</h2>
                        <div className="text-lg md:text-xl text-muted-foreground space-y-8 leading-relaxed text-left">
                            <p>
                                <span className="font-bold text-foreground">Roofing demand is feast or famine.</span> When a storm hits, your phone rings 500 times a day. You can't hire enough CSRs just for three days of chaos.
                            </p>
                            <p>
                                If you don't answer, they call the next roofer. Speed to lead is everything in storm restoration.
                            </p>
                            <p>
                                <span className="font-bold text-foreground">Traditional call centers fail you.</span> They get overwhelmed too, or they take messages that are useless because they didn't ask the right questions about damage or insurance.
                            </p>
                            <p>
                                That's why <span className="font-bold text-[#2563EB]">Clara Answers</span> is built for the surge. She can handle 10,000 concurrent calls, qualify every lead, and put appointments directly on your sales team's calendar.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-20 px-6 bg-white">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-4xl font-bold mb-4">Infinite Scale, Instant Qualification</h2>
                            <p className="text-muted-foreground max-w-2xl mx-auto">
                                A storm-ready call center that lives in the cloud.
                            </p>
                        </div>
                            ...
                            {[
                                {
                                    step: "1",
                                    icon: Phone,
                                    title: "Calls ramp up instantly",
                                    description: "A hail storm hits. Your call volume goes from 10 to 200 per hour. Clara answers every single one on the first ring."
                                },
                                {
                                    step: "2",
                                    icon: Shield,
                                    title: "Clara qualifies the lead",
                                    description: "She asks: 'Do you have visible damage?' 'What is your insurance carrier?' 'Is the roof leaking now?' She filters out the tire kickers."
                                },
                                {
                                    step: "3",
                                    icon: TrendingUp,
                                    title: "You have a routed schedule",
                                    description: "Qualified leads are booked directly into inspection slots. Your sales team just wakes up and drives to the appointments."
                                }
                            ].map((item, i) => (
                ...
                <section className="py-20 px-6">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-muted-foreground">Dominate the storm.</p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    description: "Never miss a lead during a surge."
                                },
                                {
                                    title: "24/7 coverage",
                                    description: "Capture leads while competitors sleep."
                                },
                                {
                                    title: "Qualified appointments",
                                    description: "Sales reps only visit real prospects."
                                },
                                {
                                    title: "Zero burnout",
                                    description: "Save your office staff from phone fatigue."
                                },
                                {
                                    title: "Instant scalability",
                                    description: "From 0 to 1000 calls with no hiring."
                                },
                                {
                                    title: "No agency fees",
                                    description: "Stop paying per-minute for bad messages."
                                }
                            ].map((item, i) => (
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-8 text-center border border-gray-100">
                                <p className="text-lg text-muted-foreground italic max-w-3xl mx-auto">
                                    "A massive hail storm hits your service area at 4 PM. By 5 PM, you have 50 missed calls and your office manager is in tears."
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="p-8 bg-red-50/50 rounded-2xl border border-red-100">
                                    ...
                                    <p className="text-sm text-gray-600 leading-relaxed">
                                        Before Clara: You try to call everyone back the next day. 80% have already booked with someone else. You lost $100k in potential revenue because you couldn't answer the phone.
                                    </p>
                                </div>
                                ...
                                <div className="p-8 bg-blue-50/50 rounded-2xl border border-blue-100">
                                    ...
                                    <p className="text-sm text-gray-600 leading-relaxed">
                                        With Clara: Every caller gets answered instantly. Clara qualifies them for damage and insurance, and books inspections for your team. You wake up with a full calendar and zero stress.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="p-8 bg-blue-50 rounded-2xl border border-blue-100">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    You maximize the storm opportunity without breaking your team.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-20 px-6 bg-gray-50">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-4 mb-12">
                            {[
                                "Storms are unpredictable; you can't staff up in time",
                                "Speed to lead is the #1 factor in winning storm work",
                                "Qualifying questions filter out the time-wasters immediately"
                            ].map((item, i) => (
                        ...
                        <p className="text-center text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                            Clara Answers is the secret weapon for storm restoration companies.
                        </p>
                    </div>
                </section>
            </RevealOnScroll>
                            ...
                            <div className="bg-[#10B981] p-8 rounded-3xl text-white relative overflow-hidden group">
                                <div className="relative z-10">
                                    <div className="flex gap-2 mb-4">
                                        ...
                                        <span className="px-2 py-1 bg-white/10 text-white text-xs font-bold rounded">Roofing</span>
                                    </div>
                                    <h3 className="text-xl font-bold mb-4">Do more inspections with fewer people</h3>
                                    <p className="text-green-100 text-sm mb-8">AI guidance lets less experienced techs perform like veterans.</p>
                            ...
                            <div className="bg-[#0A1A2F] p-8 rounded-3xl text-white relative overflow-hidden group">
                                <div className="relative z-10">
                                    <div className="flex gap-2 mb-4">
                                        ...
                                        <span className="px-2 py-1 bg-gray-500/20 text-gray-300 text-xs font-bold rounded">Roofing</span>
                                    </div>
            ...
            <div className="bg-black text-white py-24 px-6 text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-8">Ready to see Clara Answers in action for roofing teams?</h2>
