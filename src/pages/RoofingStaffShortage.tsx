                    ...
                    <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        <div className="max-w-6xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <ListenToClaraButton className="px-8 py-6 rounded-full text-lg font-semibold border-2 border-red-100 text-[#D32F2F] hover:bg-red-50 hover:border-[#D32F2F] hover:text-black transition-all bg-transparent" />
                            </div>
                        </div>
                    </div>
                </section>
